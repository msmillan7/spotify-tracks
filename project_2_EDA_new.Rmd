...
#Re-scale popularity so that it is measured between o and 1, as the rest of the attributes do.
tracks.df$popularity <- tracks.df$popularity/100 
#Create new column to have the duration in minutes
tracks.df["duration_min"] <- tracks.df$duration_ms/1000/60
